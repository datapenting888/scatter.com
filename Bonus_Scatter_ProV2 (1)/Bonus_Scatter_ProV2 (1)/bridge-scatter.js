...
(function() {
  ...
  // ============================================================
  // === TAMBAHAN: LISTENER UNTUK UPDATE TEMA DARI BACKGROUND ===
  // ============================================================
  chrome.runtime.onMessage.addListener((msg, sender, sendResponse) => {
    if (msg.action === 'updateThemeFont') {
      // Kirim ke halaman index.html melalui postMessage 
      // (karena bridge-scatter berjalan sebagai content script)
      window.postMessage({ 
        type: 'SCATTER_UPDATE_THEME', 
        theme: msg.theme 
      }, '*');
